...
public class PositiveCompareToTest {
    ...
    public void test1() {
        ...
        Item item2 = new Item(1L, null, 1.0);
    ...
    public void test2() {
        ...
        Item item2 = new Item(2L, null, 2.0);
    ...
    public void test3() {
        // given
        Comparator<Item> idComparator = (Comparator<Item>)new IdComparator();
        Item item1 = new Item(2L, null, 2.0);
        Item item2 = new Item(3L, null, 3.0);
    ...
    public void test4() {
        // given
        Comparator<Item> idComparator = (Comparator<Item>)new IdComparator();
        Item item1 = new Item(3L, null, 4.0);
        Item item2 = new Item(4L, null, 3.0);
    ...
    public void test5() {
        ...
        Item item2 = new Item(5L, null, 4.0);
    ...
    public void test6() {
        // given
        Comparator<Item> idComparator = (Comparator<Item>)new IdComparator();
        Item item1 = new Item(5L, null, 4.0);
        Item item2 = new Item(6L, null, 5.0);
